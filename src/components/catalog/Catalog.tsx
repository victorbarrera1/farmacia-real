  ...
  return (
    <section id="catalogo" className="py-[clamp(30px,5vw,52px)]">
      <div className="env">
        ...
        <Reveal delay={0.08} className="mt-[22px]">
          <div className="flex items-start gap-3 rounded-2xl border border-ambar-borde bg-ambar-pale px-[18px] py-4 text-[0.9rem] leading-relaxed text-[#6B4A08]">
