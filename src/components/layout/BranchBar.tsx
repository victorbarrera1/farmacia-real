...
/** Barra de sucursal: dónde retiras, si está abierto y botón para cambiar. */
export function BranchBar() {
  ...
  return (
    <div className="border-y border-azul-borde bg-azul-pale">
      <div className="env flex min-h-[52px] flex-wrap items-center gap-3 py-[9px]">
        ...
        <span
          className={`hidden items-center gap-1.5 rounded-full border border-azul-borde bg-white px-[11px] py-[5px] text-[0.82rem] font-bold text-azul-osc min-[560px]:inline-flex`}
        >
          <span
