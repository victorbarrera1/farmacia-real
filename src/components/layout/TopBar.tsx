...
/** Barra superior fina: datos rápidos, acceso a WhatsApp y al panel de gestión. */
  ...
  return (
    <div className="bg-azul-osc text-[0.83rem] text-white">
      <div className="env flex h-9 items-center gap-[18px] overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <span className="hidden items-center gap-[7px] whitespace-nowrap text-white/90 min-[520px]:flex">
          <Icon id="i-bolsa" className="size-3.5 opacity-85" /> Retiro en tienda
        </span>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          >
            <FlaskConical className="size-3.5" aria-hidden="true" /> Test
          </Link>
          <a
